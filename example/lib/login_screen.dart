...
class EzlogExampleScreen extends StatefulWidget {
  ...
  @override
  State<EzlogExampleScreen> createState() => _EzlogExampleScreenState();
}

class _EzlogExampleScreenState extends State<EzlogExampleScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        body: FutureBuilder<EzloginStatus>(
